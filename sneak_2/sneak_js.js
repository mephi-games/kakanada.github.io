...
var SLOVO_5 = ["Широкий","Простор","Для","Мечты","И","Жизни","Грядущие","Нам","Открывают","Года","Силу","Даёт","Наша","Верность","Отчизме","Так","Было","Есть","Будет","Всегда"];
...
var SLOVO_5_T_R = [0,1,2,3,4,2,5, 6,7,8,9, 8,10,11,12,13,14, 15,16,15,17,4,15,18,19];
